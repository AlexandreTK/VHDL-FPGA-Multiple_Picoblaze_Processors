...
HD_PWD='C:/Users/Alexandre/Desktop/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log global_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source global_top.tcl
