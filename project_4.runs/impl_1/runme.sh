...
HD_PWD='C:/Users/Alexandre/Desktop/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log global_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source global_top.tcl -notrace
